...
public class Listado_Form extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnCerrarS.setForeground(new java.awt.Color(255, 102, 102));
        ...
        btnActualizar.setForeground(new java.awt.Color(255, 102, 102));
    ...
    private void actualizarDatos(){
        ...
        try {
            ...
            String sql = "UPDATE `usuarios` SET `Nombre`=?,`usu`=?,`Clave`=?,`Apellido`=?,`Telefono`=?,`Correo`=? WHERE `usu` = ?";
    ...
    public void EliminarDatos(){  
        ...
        try {     
            String sql = "DELETE FROM `usuarios` WHERE `usu` = ?";
