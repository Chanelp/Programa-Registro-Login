...
public class Login_Form extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel_CrearCuenta.setForeground(new java.awt.Color(255, 153, 153));
        jLabel_CrearCuenta.setText(">>> Si no tienes una cuenta, da click aquí para crear una. <<<");
        jLabel_CrearCuenta.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
    ...
    private void jButton_LoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_LoginActionPerformed
        ...
        String query = "SELECT * FROM `usuarios` WHERE `usu` = ? AND `Clave` = ?";
